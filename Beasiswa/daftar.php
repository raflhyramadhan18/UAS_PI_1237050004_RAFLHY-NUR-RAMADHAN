            ...
            <li><img  class="image"src="foto/logo.png" border="0" width="100px" style="margin: 1px;padding: 0px color:white;"></li>
                ...
                <div class="collapse navbar-collapse d-flex justify-content-end" id="navbarNav">
                    <ul class="nav nav-pills ">
                        ...
                        <li class="nav-item mx-4">
                            <a class="nav-link active text-light" aria-current="page" href="daftar.php">Daftar</a>
                        </li>
                        <li class="nav-item mx-4">
                    ...
                    <form action="simpan.php" method="post" enctype="multipart/form-data">
                            ...
                            <?php
                                function generateRandomIPK() {
                                    $ipk = number_format(mt_rand(250, 350) / 100, 2);
                                    return $ipk;
                                }
                                $ipk_mahasiswa = generateRandomIPK();
                                ?>
                                <div class="col">
                            ...
                            if ($ipk_mahasiswa >= 3.00) {
                                echo   "<div class='row mb-3'>
                                    ...
                                    echo   "<div class='row mb-3'>
                                        ...
                                        <button type="button" class="btn btn-success btn-md" onclick="history.back(-1)">Kembali</button>
                                </div>
                        </form>
                    </div>
                </div>
