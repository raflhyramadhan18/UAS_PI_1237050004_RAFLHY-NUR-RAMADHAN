...
//proses simpan
$query="INSERT INTO data_beasiswa(nama, email, nomor, semester, nilai, pilihan_beasiswa, berkas,id)
        VALUES('$nama', '$email', '$nomor', '$semester', '$nilai','$pilihan_beasiswa','$nama1','$id')";
